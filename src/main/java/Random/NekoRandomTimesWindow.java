 ...
 * @author PIPHAT
 */
public class NekoRandomTimesWindow extends javax.swing.JFrame {
...
ImageIcon Cat_Warning = new ImageIcon("C://My Learing//Java//DIT102//GachaProgram//photo//Cat Warning.gif");
    ...
    public NekoRandomTimesWindow(String Gacha) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\My Learing\\Java\\DIT102\\GachaProgram\\photo\\Cat Random.gif")); // NOI18N
            ...
            if (Method.get_exchange(SignUpWindow.get_id()) < 1) {
                ...
                for (int i = 0; i < 1; i++) {
                    ...
                    if (temp[0].equals("99")) {
                        ...
                        JOptionPane.showMessageDialog(null, "Nyan Nyan!", "", JOptionPane.INFORMATION_MESSAGE, Neko);
                        try {
                ...
                NekoRecieveWindow NRW = new NekoRecieveWindow(1);
    ...
    private void fivetimeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fivetimeActionPerformed
        ...
        try {
            if (Method.get_exchange(SignUpWindow.get_id()) <= 4) {
                ...
                NekoRecieveWindow NRW = new NekoRecieveWindow(5);
                this.setVisible(false);
                NRW.setVisible(true);
            }
    ...
    private void tentimeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tentimeActionPerformed
        ...
        try {
            if (Method.get_exchange(SignUpWindow.get_id()) <= 9) {
                ...
                NekoRecieveWindow NRW = new NekoRecieveWindow(10);
                this.setVisible(false);
                NRW.setVisible(true);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NekoRandomTimesWindow.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NekoRandomTimesWindow(null).setVisible(true);
            }
        });
    }
