 ...
 * @author PIPHAT
 */
public class NekoRecieveWindow extends javax.swing.JFrame {

    /**
     * Creates new form ItemWhatYouHaveWindow
     */

    public NekoRecieveWindow(int number) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\My Learing\\Java\\DIT102\\GachaProgram\\photo\\Cat Recieve.gif")); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        NekoRandomTimesWindow NRW = new NekoRandomTimesWindow(NekoRandomTimesWindow.GachaID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NekoRecieveWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new NekoRecieveWindow(0).setVisible(true);
            }
        });
    }
